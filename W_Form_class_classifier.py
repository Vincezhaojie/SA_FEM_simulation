...
logdir = "{}/W_Form_class-{}".format(root_logdir, now)
...
pickle_out = open("W_Form_class_MinMaxScaler.pickle", "wb")
...
if random_search is True:
    model = KerasClassifier(build_fn=create_model, verbose=0, epochs=220)
    neurons = [120, 150, 180, 200, 250, 300, 400]
    ...
    tf.train.write_graph(frozen_graph, './', 'W_Form_class_classifier.pb', as_text=False)
